...
function HomeArticle() {
  ...
  return (
    <>
      <div className=" home-art pb-20">
        <div className="art-header pb-12 pt-20 flex max-w-6xl mx-auto justify-around items-center">
          <h2 className="text-right lg:w-1/2 lg:ml-20 font-bold text-3xl">
            Artikel Terbaru
          </h2>
          <button
        ...
        <div className="article max-w-6xl flex justify-center mx-auto flex-wrap gap-6 pb-20">
          {sortArticles.slice(0, 3).map((article) => {
            return (
              <div
                key={article.id}
                className="card-art bg-white rounded-2xl gap-6 flex flex-col overflow-hidden"
              >
        ...
        <div className="flex justify-center w-full -mt-10">
          <button
            onClick={() => navigate("/article")}
            className=" bg-primary-1 hover:bg-primary-2 px-4 py-3 rounded-lg flex lg:hidden"
          >
            <p className="text-white font-semibold">View More</p>
            <svg
              width="24"
